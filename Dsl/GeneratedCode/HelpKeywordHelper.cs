...
namespace SPbSU.RobotsLanguage
{
	...
	/// </remarks>
	public partial class RobotsLanguageHelpKeywordHelper : RobotsLanguageHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new RobotsLanguageHelpKeywordHelper.
		/// </summary>
		protected RobotsLanguageHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the RobotsLanguageHelpKeywordHelper.
		/// </summary>
		public static RobotsLanguageHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class RobotsLanguageHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new RobotsLanguageHelpKeywordHelperBase.
		/// </summary>
		protected RobotsLanguageHelpKeywordHelperBase()
			: base() { }
