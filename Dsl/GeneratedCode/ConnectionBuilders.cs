...
namespace SPbSU.RobotsLanguage
{
	...
	/// </summary>
	public static partial class AbstractNodeReferencesTargetAbstractNodeBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::SPbSU.RobotsLanguage.AbstractNode)
			{ 
				return true;
			}
			else
			...
			else // Check combinations
			{
				if (candidateSource is global::SPbSU.RobotsLanguage.AbstractNode)
				{
					if (candidateTarget is global::SPbSU.RobotsLanguage.AbstractNode)
					{
						...
						if(targetAbstractNode == null || sourceAbstractNode == null || global::SPbSU.RobotsLanguage.AbstractNodeReferencesTargetAbstractNode.GetLinks(sourceAbstractNode, targetAbstractNode).Count > 0) return false;
						return true;
					}
				}
	...
	internal partial class ConnectionTool1ConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class ConnectionTool1ConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder AbstractNodeReferencesTargetAbstractNodeBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return AbstractNodeReferencesTargetAbstractNodeBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return AbstractNodeReferencesTargetAbstractNodeBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				AbstractNodeReferencesTargetAbstractNodeBuilder.Connect(sourceElement, targetElement);
			}
		}
