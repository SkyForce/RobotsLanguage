...
namespace SPbSU.RobotsLanguage
{
	...
	/// </summary>
	internal partial class RobotsLanguageDocView : RobotsLanguageDocViewBase
	{
		/// <summary>
		/// Constructs a new RobotsLanguageDocView.
		/// </summary>
		public RobotsLanguageDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RobotsLanguageDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new RobotsLanguageDocView.
		/// </summary>
		protected RobotsLanguageDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			RobotsLanguageDocDataBase docData = this.DocData as RobotsLanguageDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for RobotsLanguageDocViewBase should be an RobotsLanguageDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::SPbSU.RobotsLanguage.RobotsLanguageDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::SPbSU.RobotsLanguage.RobotsLanguageDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::SPbSU.RobotsLanguage.RobotsLanguageToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::SPbSU.RobotsLanguage.RobotsLanguageToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.RobotsLanguageDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::SPbSU.RobotsLanguage.RobotsLanguageHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::SPbSU.RobotsLanguage.RobotsLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::SPbSU.RobotsLanguage.RobotsLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
