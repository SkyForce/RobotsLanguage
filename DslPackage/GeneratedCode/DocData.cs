...
namespace SPbSU.RobotsLanguage
{
	...
	/// </summary>
	internal partial class RobotsLanguageDocData : RobotsLanguageDocDataBase
	{
		/// <summary>
		/// Constructs a new RobotsLanguageDocData.
		/// </summary>
		public RobotsLanguageDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a RobotsLanguage document in memory.
	/// </summary>
	internal abstract partial class RobotsLanguageDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new RobotsLanguageDocDataBase.
		/// </summary>
		protected RobotsLanguageDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::SPbSU.RobotsLanguage.RobotsLanguageDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::SPbSU.RobotsLanguage.RobotsLanguageDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(RobotsLanguageExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::SPbSU.RobotsLanguage.RobotsLanguageDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::SPbSU.RobotsLanguage.RobotsLanguageDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::SPbSU.RobotsLanguage.RobotModel modelRoot = null;
			...
			global::SPbSU.RobotsLanguage.RobotsLanguageDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::SPbSU.RobotsLanguage.RobotsLanguageSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, this.ValidationController, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::SPbSU.RobotsLanguage.RobotsLanguageDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::SPbSU.RobotsLanguage.RobotsLanguageDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::SPbSU.RobotsLanguage.RobotModel modelRoot = (global::SPbSU.RobotsLanguage.RobotModel)this.RootElement;
			...
			{
				global::SPbSU.RobotsLanguage.RobotsLanguageDiagram diagram = diagrams[0] as global::SPbSU.RobotsLanguage.RobotsLanguageDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::SPbSU.RobotsLanguage.RobotsLanguageSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::SPbSU.RobotsLanguage.RobotsLanguageSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::SPbSU.RobotsLanguage.RobotsLanguageDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::SPbSU.RobotsLanguage.RobotsLanguageSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::SPbSU.RobotsLanguage.RobotModel modelRoot = this.RootElement as global::SPbSU.RobotsLanguage.RobotModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::SPbSU.RobotsLanguage.RobotsLanguageSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
