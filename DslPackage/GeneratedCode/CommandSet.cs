...
namespace SPbSU.RobotsLanguage
{
	...
	/// </summary>
	internal partial class RobotsLanguageCommandSet : RobotsLanguageCommandSetBase
	{
		/// <summary>
		/// Constructs a new RobotsLanguageCommandSet.
		/// </summary>
		public RobotsLanguageCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class RobotsLanguageCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new RobotsLanguageCommandSetBase.
		/// </summary>
		protected RobotsLanguageCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewRobotsLanguageExplorerCommand,
				typeof(RobotsLanguageEditorFactory).GUID);
		...
		{
			RobotsLanguageExplorerToolWindow explorer = this.RobotsLanguageExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentRobotsLanguageDocData != null && this.CurrentRobotsLanguageDocData.Store != null)
			{
				this.CurrentRobotsLanguageDocData.ValidationController.Validate(this.CurrentRobotsLanguageDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentRobotsLanguageDocData != null && this.CurrentRobotsLanguageDocData.Store != null)
			{
				...
				this.CurrentRobotsLanguageDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected RobotsLanguageDocData CurrentRobotsLanguageDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as RobotsLanguageDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected RobotsLanguageDocView CurrentRobotsLanguageDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as RobotsLanguageDocView;
			}
		}
		...
		/// </summary>
		protected RobotsLanguageExplorerToolWindow RobotsLanguageExplorerToolWindow
		{
			get
			{
				RobotsLanguageExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(RobotsLanguageExplorerToolWindow), true) as RobotsLanguageExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				RobotsLanguageExplorerToolWindow explorerWindow = this.RobotsLanguageExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class RobotsLanguageClipboardCommandSet : RobotsLanguageClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new RobotsLanguageClipboardCommandSet.
		/// </summary>
		public RobotsLanguageClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class RobotsLanguageClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new RobotsLanguageClipboardCommandSetBase.
		/// </summary>
		protected RobotsLanguageClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
